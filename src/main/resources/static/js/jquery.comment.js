(function($){
	function crateCommentInfo(obj){
		...
		if(typeof(obj.address) != "undefined" && obj.browse != ""){
			el =el+"<span><i class='fa fa-map-marker'></i>"+obj.address+"</span>";
		}
		...
		if(typeof(obj.osname) != "undefined" && obj.osname != ""){
			el =el+"<span><i class='fa fa-thumb-tack'></i> 来自:"+obj.osname+"</span>";
		}
		
		if(typeof(obj.browse) != "undefined" && obj.browse != ""){
			el = el + "<span><i class='fa fa-globe'></i> "+obj.browse+"</span>";
		}
	...
	function replyClick(el){
		el.parent().parent().append("<div class='replybox'><textarea cols='80' rows='50' placeholder='说点什么吧......' class='mytextarea' ></textarea><span class='send'>发送</span></div>")
